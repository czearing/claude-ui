// src/app/repos/[repo]/skills/SkillsPage.tsx
"use client";
...
export function SkillsPage({ repo, selectedSkillName }: SkillsPageProps) {
  ...
  function handleSelect(name: string | null) {
    ...
    if (name) {
      window.history.replaceState(
        null,
        "",
        `/repos/${repo}/skills/${encodeURIComponent(name)}`,
      );
    } else {
      window.history.replaceState(null, "", `/repos/${repo}/skills`);
    }
  }

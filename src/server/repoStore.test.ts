...
describe("readRepos", () => {
  ...
  it("returns parsed repos when file exists", async () => {
    const repos = [
      { id: "repo-1", name: "My Repo", path: "/home/user/repo", createdAt: "2026-01-01T00:00:00.000Z" },
      { id: "repo-2", name: "Other Repo", path: "/home/user/other", createdAt: "2026-02-01T00:00:00.000Z" },
    ];
...
describe("writeRepos", () => {
  ...
  it("writes repos as pretty-printed JSON with 2-space indent", async () => {
    ...
    const repos = [
      { id: "repo-1", name: "Test Repo", path: "/path/to/repo", createdAt: "2026-01-01T00:00:00.000Z" },
    ];
